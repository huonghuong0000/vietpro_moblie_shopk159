...
<div id="my-cart">
	...
	?>
		<div class="cart-item row">
			...
			<div onclick="return XoaSP();" class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo $total_price;?>đ</b><a
...
//////////////////////////                         // Passing 'true' enables exceptions
    ...
    try {
        //Server settings
        $mail->SMTPDebug = 2;   
        $mail->IsSMTP(); //Thiết lập SMTP                              // Enable verbose debug output                                    // Set mailer to use SMTP
        $mail->Host = 'smtp.gmail.com';  // Specify main and backup SMTP servers
        $mail->SMTPAuth = true;                               // Enable SMTP authentication
        $mail->Username = 'huongkute0000@gmail.com';                 // SMTP username
        $mail->Password = '01644252450Huong';                           // SMTP password
