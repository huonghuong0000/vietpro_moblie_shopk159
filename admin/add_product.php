...
// kiểm tra có click nút thêm mới chưa
if(isset($_POST['sbm'])){
    ...
    $sql = "INSERT INTO product(prd_name, prd_price, prd_warranty, prd_accessories,
        prd_promotion, prd_new, prd_image, cat_id, prd_status, prd_featured,
        prd_details) VALUES('$prd_name','$prd_price','$prd_warranty',
        '$prd_accessories','$prd_promotion','$prd_new','$prd_image',
        '$cat_id','$prd_status','$prd_featured','$prd_details')";
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required name="prd_image" type="file" id="file" onchange="return Check();">
                                    <br>
                                    <div id="imagePreview">
